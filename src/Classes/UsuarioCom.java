...
public class UsuarioCom  implements Usuarios{
    ...
    */
    ...
    public Usuarios setTipo(String tipo) {
        ...
        if (tipo.equalsIgnoreCase("funcionario")) {
           ...
           Usuarios b=new UsuarioFunc(nome, cpf, rg, telefone, endereco,divida);

           return b;

        }else if (tipo.equalsIgnoreCase("normal")) {

             Usuarios b=new UsuarioNormal(nome, cpf, rg, telefone, endereco,divida);
