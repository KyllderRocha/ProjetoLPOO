...
public abstract class UsuarioAbstrato implements Usuarios {
    ...
    public UsuarioAbstrato(String nome,String cpf,String rg,String telefone,String endereco, String tipo,int qtdObras){
    ...
    public UsuarioAbstrato(String nome,String cpf,String rg,String telefone,String endereco, double divida, String tipo,int qtdObras){
